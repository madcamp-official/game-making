...
| 잉어킹 스프라이트 | PMD Sprite Repository (PMDCollab/SpriteCollab, sprite/0129) | CHUNSOFT (공식 PMD 유래, sprite_credits.txt 기준) | 3층 이벤트, 3층 보스가 소환하는 고정 장애물 | `Assets/ThirdParty/PMDCollab/0129_Magikarp/sprite_credits.txt` | 완료 (이벤트용 Idle, 소환물용 Hop, 2026-07-28) |
...
| 캐터피 스프라이트 | PMD Sprite Repository (PMDCollab/SpriteCollab, sprite/0010) | CHUNSOFT (공식 PMD 유래, credits.txt 기준) | 1층 잡몹 (근접) | `Assets/ThirdParty/PMDCollab/0010_Caterpie/credits.txt` | 완료 (Walk, 2026-07-27) |
| 단데기 스프라이트 | PMD Sprite Repository (PMDCollab/SpriteCollab, sprite/0011) | CHUNSOFT (공식 PMD 유래, credits.txt 기준) | 1층 잡몹 (근접·고체력) | `Assets/ThirdParty/PMDCollab/0011_Metapod/credits.txt` | 완료 (Walk, 2026-07-27) |
| 콘팡 스프라이트 | PMD Sprite Repository (PMDCollab/SpriteCollab, sprite/0048) | CHUNSOFT (공식 PMD 유래). credits.txt에 CC BY-NC 4.0 기여자 항목이 하나 더 있으나 그건 EventSleep·Wake 등 다른 동작이고, 이 프로젝트가 쓰는 Walk·Charge는 CHUNSOFT 항목이다 | 1층 잡몹 (독 장판) | `Assets/ThirdParty/PMDCollab/0048_Venonat/credits.txt` | 완료 (Walk·Charge, 2026-07-27) |
| 모다피 스프라이트 | PMD Sprite Repository (PMDCollab/SpriteCollab, sprite/0069) | CHUNSOFT (공식 PMD 유래, credits.txt 기준) | 1층 잡몹 (탄환) | `Assets/ThirdParty/PMDCollab/0069_Bellsprout/credits.txt` | 완료 (Walk·Charge, 2026-07-27) |
| 스라크 스프라이트 | PMD Sprite Repository (PMDCollab/SpriteCollab, sprite/0123) | CHUNSOFT (공식 PMD 유래, credits.txt 기준) | 1층 잡몹 (돌진) | `Assets/ThirdParty/PMDCollab/0123_Scyther/credits.txt` | 완료 (Walk·Charge, 2026-07-27) |
...
| 라틴 폰트 시트 (`PMD_Font_Latin.png`) | [The Spriters Resource, PMD: Explorers of Time/Darkness, asset 19950](https://www.spriters-resource.com/ds_dsi/pokemonmysterydungeonexplorersoftimedarkness/asset/19950/) | John2k4 (립), 원저작 Spike Chunsoft / Game Freak | UI 폰트 (`PMDFont`)의 영문·숫자·문장부호. 원본은 `Assets/ThirdParty/SpritersResource/PMD_Explorers_Fonts/Source/` | 시트 하단 "Ripped by John2k4. Sprites © Game Freak" | 완료 (2026-07-25) |
| 한글 폰트 시트 (`PMD_Font_Korean.png`) | [The Spriters Resource, PMD: Explorers of Time/Darkness, asset 111447](https://www.spriters-resource.com/ds_dsi/pokemonmysterydungeonexplorersoftimedarkness/asset/111447/) | audino (립), 원저작 Spike Chunsoft | UI 폰트 (`PMDFont`)의 한글 완성형·자모. 원본은 `Assets/ThirdParty/SpritersResource/PMD_Explorers_Fonts/Source/` | 사이트 에셋 페이지 | 완료 (2026-07-25) |
| 플레이어 계열 표정 초상 (`{이름}_Dizzy.png`, `{이름}_Happy.png`) | PMD Sprite Repository (PMDCollab/SpriteCollab, `portrait/0001`~`0009`) | 각 종의 `portrait_credits.txt` 참고 (CHUNSOFT 및 PMDCollab 기여자) | 결과 화면 — 쓰러지면 Dizzy, 클리어하면 Happy | `Assets/ThirdParty/PMDCollab/000{1..9}_*/portrait_credits.txt` | 완료 (세 계열 아홉 단계 18장, 2026-07-31) |
| 진화 컷씬 그림 (`Evolution/{이름}.png`) | [PokeAPI/sprites](https://github.com/PokeAPI/sprites) — `generation-iv/heartgold-soulsilver/{도감번호}.png` | 원저작 Game Freak / Nintendo (PokeAPI는 수집·배포) | 진화 컷씬의 진화 전·후 모습 | 저장소 README | 완료 (세 계열 아홉 단계 9장 80×80, 2026-07-31) |
