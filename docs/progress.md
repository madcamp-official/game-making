...
| 단계 3 — 유물과 런 상태 | 완료 | 유물 11종(뽑기 더미 방식), 유물 HUD·툴팁, 게임 오버·R 재시작 |
...
| 기력의 덩어리 | 획득 즉시 최대 체력의 33% 회복 | `RelicManager.ApplyOnAcquire` |
...
- **부활 수단이 없어졌다.** 자뭉열매(1회 부활)가 기력의 덩어리(즉시 회복)로 바뀌면서 `PlayerDeathHandler`의 부활 분기를 걷어냈다. 다시 넣으려면 유물 효과를 추가하고 거기서 분기하면 된다
